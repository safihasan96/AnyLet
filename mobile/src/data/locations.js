export const bdLocations = {
    "Barishal": {
        ...
        "Barishal": ["Agailjhara", "Babuganj", "Bakerganj", "Banaripara", "Gournadi", "Hizla", "Barishal Sadar", "Mehendiganj", "Muladi", "Uzirpur"],
    ...
    "Chattogram": {
        ...
        "Chattogram": ["Anwara", "Banshkhali", "Boalkhali", "Chandanaish", "Fatikchhari", "Hathazari", "Karnafuli", "Lohagara", "Mirsarai", "Patiya", "Rangunia", "Raozan", "Sandwip", "Satkania", "Sitakunda", "Kotwali (Sadar)"],
        "Comilla": ["Barura", "Brahmanpara", "Burichang", "Chandina", "Chauddagram", "Cumilla Sadar", "Cumilla Sadar Dakshin", "Daudkandi", "Debidwar", "Homna", "Laksam", "Meghna", "Monohargonj", "Muradnagar", "Nangalkot", "Titas"],
    ...
    "Dhaka": {
        "Dhaka": [
            "Uttara", "Uttara West", "Pallabi", "Mirpur-1", "Mirpur-2", "Kafrul", "Dakshinkhan", "Turag",
            "Gulshan", "Badda", "Khilkhet", "Vatara", "Cantonment", "Tejgaon", "Tejgaon Sadar",
            "Rayer Bazar", "Mohammadpur", "Adabor", "Sher-e-Bangla Nagar", "Dhanmondi", "Kalabagan",
            "New Market", "Hazaribagh", "Kamrangirchar", "Lalbagh", "Chokbazar", "Kotwali",
            "Sutrapur", "Wari", "Gendaria", "Kadamtali", "Shyampur", "Demra", "Jatrabari",
            "Khilgaon", "Mugda", "Sabujbagh", "Motijheel", "Paltan", "Shahbag", "Ramna",
            "Shah Ali", "Bangshal", "Savar", "Dhamrai", "Dohar", "Nawabganj", "Keraniganj"
        ],
    ...
    "Khulna": {
        ...
        "Khulna": ["Batiaghata", "Dacope", "Dighalia", "Dumuria", "Koyra", "Paikgachha", "Phultala", "Rupsha", "Terokhada", "Khalishpur", "Khulna Sadar", "Sonadanga"],
    ...
    "Mymensingh": {
        ...
        "Mymensingh": ["Bhaluka", "Dhobaura", "Fulbaria", "Gafargaon", "Gauripur", "Haluaghat", "Iswarganj", "Muktagacha", "Mymensingh Sadar", "Nandail", "Phulpur", "Trishal"],
    ...
    "Sylhet": {
        "Habiganj": ["Ajmiriganj", "Baniachong", "Bahubal", "Chunarughat", "Habiganj Sadar", "Lakhai", "Madhabpur", "Nabiganj", "Shaistaganj"],
        "Moulvibazar": ["Barlekha", "Juri", "Kamalganj", "Kulaura", "Moulvibazar Sadar", "Rajnagar", "Sreemangal"],
        "Sunamganj": ["Bishwambarpur", "Chhatak", "Derai", "Dharmapasha", "Dowarabazar", "Jagannathpur", "Jamalganj", "Sulla", "Sunamganj Sadar", "Tahirpur"],
